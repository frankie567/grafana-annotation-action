...
const rax = __importStar(__webpack_require__(6875));
class GrafanaClient {
    ...
    createAnnotation(text, timestamp, dashboardId, panelId, tags) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = Object.assign(Object.assign(Object.assign({ text, time: timestamp }, dashboardId ? { dashboardId } : {}), panelId ? { panelId } : {}), tags ? { tags } : {});
            const response = yield this.client.post('/annotations', data);
...
const grafana_1 = __webpack_require__(2481);
